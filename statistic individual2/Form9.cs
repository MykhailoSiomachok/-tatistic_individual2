...
namespace statistic_individual2
{
    public partial class Form9 : Form
    {
        ...
        public Dictionary<List<double>, int> Group_check(Dictionary<List<double>, int> k)
        {
            Dictionary<List<double>, int> Checked_dict = new Dictionary<List<double>, int>();
            List<List<double>> Keys = new List<List<double>>(k.Keys);
            Keys.RemoveAt(0);
            Keys.RemoveAt(Keys.Count - 1);
            List<int> Values = new List<int>(k.Values);
            Values.RemoveAt(0);
        ...
        public void Texto(Dictionary<List<double>, int> k, double average, double standart, double alpha)
        {
            var x_empiric = 0.0;
            int i = 0;
        ...
        public List<double> Prob(double average, double standart, Dictionary<List<double>, int> k)
        {
